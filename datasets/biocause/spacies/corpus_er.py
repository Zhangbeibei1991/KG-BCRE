...
class CorpusER(object):
    ...
    def __init__(self, nlp, keep_ent_tokens, attrs=(
    'is_entity', 'entity_id', 'entity_type', 'is_trigger', 'trigger_id',
    'trigger_type', 'arg_type', 'arg_of_id', 'arg_of_position', 'arg_of_ev_type', 'span')):
        """Initialization of the module."""

        # Set the attributes of the class
        self.keep_ent_tokens = keep_ent_tokens
        self._is_entity, self._entity_id, self._entity_type, \
        self._is_trigger, self._trigger_id, self._trigger_type, \
        self._arg_type, self._arg_of_id, self._arg_of_position, self._arg_of_ev_type, self._span = attrs
                ...
                for id_, mention in ann_dict.items():
                    ...
                    if matched_mention is not None:
                        ...
                        for token in matched_mention:
                            token._.set(self._span, str(mention_start + doc._.start_char) + "-" + str(
